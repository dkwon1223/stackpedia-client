...
const Loader: FC<LoaderProps> = ({ width = 94, height = 136, scale = 1.2 }) => {
  return (
    <StyledWrapper scale={scale}>
      <svg id="svg-global" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 94 136" height={height} width={width}>
