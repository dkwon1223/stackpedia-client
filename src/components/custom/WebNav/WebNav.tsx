...
import { ArrowRightStartOnRectangleIcon, ChevronDownIcon, ChevronUpIcon, Cog6ToothIcon, Cog8ToothIcon, HomeIcon, InboxIcon, LightBulbIcon, MagnifyingGlassIcon, MegaphoneIcon, PlusIcon, QuestionMarkCircleIcon, ShieldCheckIcon, SparklesIcon, Square2StackIcon, TicketIcon, UserIcon } from "@heroicons/react/16/solid";
          ...
          <SidebarHeader>
            <Dropdown>
              <DropdownButton as={SidebarItem} className="lg:mb-2.5">
                <Avatar src="/stack.svg" />
                <SidebarLabel>StackPedia</SidebarLabel>
                <ChevronDownIcon />
              </DropdownButton>
