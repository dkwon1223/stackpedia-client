...
import { HERO_NAV_CONFIG } from '@/constants/navigation';
    ...
    <div className="bg-slate-950">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {HERO_NAV_CONFIG.heroNavItems.map((item) => (
      ...
      <main>
        <div className="relative isolate">
          <svg
            aria-hidden="true"
            className="absolute inset-x-0 top-0 -z-10 h-full w-full mask-[radial-gradient(32rem_32rem_at_center,white,transparent)] stroke-white/10"
          >
            <defs>
              <pattern
                x="50%"
          ...
          >
            <div
              ...
              className="aspect-901/1036 w-200.25 bg-linear-to-tr from-[#380fbe] to-[#9089fc] opacity-30"
            />
          </div>
            ...
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-5xl font-semibold tracking-tight text-pretty text-white sm:text-7xl mb-4">
                    {HERO_CONTENT.appTitle}
                  </h1>
                  <h2 className="text-2xl font-semibold tracking-tight text-pretty text-gray-300 sm:text-3xl">
